...
>;
export declare const fetchUsers: import("@reduxjs/toolkit").AsyncThunk<
  import("../../services/api/admin.api").AdminUserResponse[],
  void,
  import("@reduxjs/toolkit").AsyncThunkConfig
>;
export declare const fetchAuditLogs: import("@reduxjs/toolkit").AsyncThunk<
  import("../../services/api/admin.api").AuditLogResponse[],
  void,
  import("@reduxjs/toolkit").AsyncThunkConfig
>;
