...
export function getUserGrowthOptions(data) {
    return {
        chart: { type: 'area' },
...
export function getSystemLoadOptions(data) {
    return {
        chart: { type: 'line' },
        title: { text: undefined },
        xAxis: { categories: data.categories, crosshair: true },
...
export function getApiResponseTimeOptions(data) {
    return {
        chart: { type: 'line' },
        title: { text: undefined },
        xAxis: { categories: data.categories, crosshair: true },
...
export function getErrorRateOptions(data) {
    const errorRates = data.errors.map((e, i) => data.totalRequests[i] > 0
