...
export function getSpendingOverviewOptions(data) {
    return {
        chart: { type: 'area' },
...
export function getIncomeVsExpenseOptions(data) {
    return {
        chart: { type: 'column' },
        title: { text: undefined },
...
export function getCategoryDistributionOptions(data) {
    return {
        chart: { type: 'pie' },
        title: { text: undefined },
        tooltip: {
            pointFormat: '<b>{point.percentage:.1f}%</b><br/>Amount: <b>₹{point.y:,.0f}</b>',
        },
        plotOptions: {
            pie: {
                innerSize: '55%',
...
export function getSavingsRateOptions(data) {
    return {
        chart: { type: 'line' },
        title: { text: undefined },
