...
export function getMonthlyTrendOptions(data) {
    return {
        chart: { type: 'line' },
        ...
        tooltip: {
            ...
            formatter() {
                ...
                points.forEach((p) => {
                    const val = p.series.name === 'Amount'
...
export function getCategoryPieOptions(data) {
    return {
        chart: { type: 'pie' },
        title: { text: undefined },
        tooltip: {
...
export function getDailySpendingOptions(data) {
    return {
        chart: { type: 'column' },
        title: { text: undefined },
        xAxis: {
