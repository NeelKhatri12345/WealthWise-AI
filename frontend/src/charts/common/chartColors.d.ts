export declare const CHART_COLORS: {
    ...
    readonly categorical: readonly ["#6366f1", "#10b981", "#f59e0b", "#ef4444", "#3b82f6", "#8b5cf6", "#ec4899", "#14b8a6", "#f97316", "#06b6d4"];
    readonly sequential: readonly ["#eef2ff", "#c7d2fe", "#a5b4fc", "#818cf8", "#6366f1", "#4f46e5", "#4338ca", "#3730a3"];
    readonly diverging: {
    ...
    readonly gauge: {
        ...
        readonly bands: readonly ["#ef4444", "#f97316", "#f59e0b", "#84cc16", "#10b981"];
    };
};
