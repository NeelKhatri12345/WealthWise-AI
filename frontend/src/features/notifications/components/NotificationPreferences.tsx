    ...
    <div className="rounded-xl bg-white p-6 shadow-sm border border-gray-100">
      ...
      <div className="space-y-4">
        ...
        {preferences.map((pref) => (
          <div key={pref.key} className="grid grid-cols-[1fr_auto_auto] items-center gap-4 py-2">
            <div>
            ...
            <div className="flex w-16 justify-center">
              ...
              >
                <span className={`block h-4 w-4 rounded-full bg-white shadow transition-transform ${pref.email ? 'translate-x-5' : 'translate-x-1'}`} />
              </button>
            </div>
            <div className="flex w-16 justify-center">
              <button
              ...
              >
                <span className={`block h-4 w-4 rounded-full bg-white shadow transition-transform ${pref.push ? 'translate-x-5' : 'translate-x-1'}`} />
              </button>
            </div>
          </div>
        ))}
