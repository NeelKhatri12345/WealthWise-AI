...
export const TransactionDetail = ({ transaction, isOpen, onClose }: TransactionDetailProps) => {
      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-4">
          <div className="text-center">
            <p className={`text-3xl font-bold ${transaction.type === 'credit' ? 'text-green-600' : 'text-red-600'}`}>
