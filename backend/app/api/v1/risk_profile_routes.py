...
@router.get("/latest", response_model=APIResponse[RiskProfileResponse], summary="Get latest risk profile")
...
@router.get("/history", response_model=APIResponse[List[RiskProfileResponse]], summary="Get risk profile history")
async def get_risk_profile_history(
    ...
    return APIResponse(success=True, message="Risk profile history retrieved", data=history)
